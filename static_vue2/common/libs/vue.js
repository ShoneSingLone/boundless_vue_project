...
(function (genVue) {
	...
	function prependModifierMarker(symbol, name, dynamic) {
		return dynamic
			? "prependModifier(".concat(name, ',"').concat(symbol, '")')
	...
	function genCheckboxModel(el, value, modifiers) {
		...
		addHandler(
			...
			"var $$a=".concat(value, ",") +
				...
				"if(Array.isArray($$a)){" +
				"var $$v=".concat(
					number ? "toNumber(" + valueBinding + ")" : valueBinding,
					","
				) +
				"$$i=looseIndexOf($$a,$$v);" +
	...
	function genRadioModel(el, value, modifiers) {
		...
		var valueBinding = getBindingAttr(el, "value") || "null";
		valueBinding = number
			? "toNumber(".concat(valueBinding, ")")
			: valueBinding;
		addProp(
			el,
			"checked",
			"looseEqual(".concat(value, ",").concat(valueBinding, ")")
		);
		addHandler(
			el,
			"change",
		...
		return propsArray.reduce(function (preProps, afterProps) {
			for (var prop in afterProps)
				if (!preProps[prop]) {
					...
					var d =
							preProps[prop] instanceof Array
								? preProps[prop]
								: [preProps[prop]],
						e =
