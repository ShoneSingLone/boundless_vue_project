...
declare module "../index" {
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new function.
		 */
		overEvery<T, Result1 extends T, Result2 extends T>(...predicates: [(arg: T) => arg is Result1, (arg: T) => arg is Result2]): (arg: T) => arg is Result1 & Result2;
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new function.
		 */
		overSome<T, Result1 extends T, Result2 extends T>(...predicates: [(arg: T) => arg is Result1, (arg: T) => arg is Result2]): (arg: T) => arg is Result1 | Result2;
