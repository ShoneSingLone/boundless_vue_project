import { ComponentPropsOptions, ExtractDefaultPropTypes, ExtractPropTypes } from "./v3-component-props";
import {
	MethodOptions,
	ComputedOptions,
...
import { ComponentPublicInstanceConstructor, CreateComponentPublicInstance } from "./v3-component-public-instance";
...
> = ComponentPublicInstanceConstructor<CreateComponentPublicInstance<Props, RawBindings, D, C, M, Mixin, Extends, E, Props, Defaults, true> & Props> &
...
>(options: { functional?: never } & ComponentOptionsWithoutProps<{}, RawBindings, D, C, M, Mixin, Extends, Emits, EmitsNames>): DefineComponent<{}, RawBindings, D, C, M, Mixin, Extends, Emits>;
 ...
 */
export function defineComponent<PropNames extends string, Props = Readonly<{ [key in PropNames]?: any }>>(options: {
	functional: true;
	props?: PropNames[];
 ...
 */
export function defineComponent<PropsOptions extends ComponentPropsOptions = ComponentPropsOptions, Props = ExtractPropTypes<PropsOptions>>(options: {
	functional: true;
	props?: PropsOptions;
	render?: (h: CreateElement, context: RenderContext<Props>) => any;
