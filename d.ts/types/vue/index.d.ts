...
export { VNodeChildren, VNodeChildrenArrayContents, VNode, VNodeComponentOptions, VNodeData, VNodeDirective, ComponentCustomProps } from "./vnode";
...
export { ComponentInstance, ComponentPublicInstance, CreateComponentPublicInstance, ComponentCustomProperties } from "./v3-component-public-instance";
export {
	// PropType,
	// PropOptions,
	ExtractPropTypes,
...
export { DirectiveModifiers, DirectiveBinding, DirectiveHook, ObjectDirective, FunctionDirective, Directive } from "./v3-directive";
