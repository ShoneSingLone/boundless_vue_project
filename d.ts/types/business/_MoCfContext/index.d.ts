...
export type t_MoCfContext = {
	...
	getFirstServiceId(service_type: string): string;
	/**
	 * mo 通用请求参数添加 header
	 */
	 ...
	 */
	ensureApplyResponse(options: { response: object; moBuyLayerConfigs: object; goBack: Function }): Promise<string>;
	/*
	 * 申请服务 必要的productId
	 * url 与当前产品有关
	 * @returns {Promise<string>}
	...
	appConfigs: {
		...
		manageOneOnline: "";
		moScale: "MO200VM";
		resourceManagerEndpoints: ["home", "vpc", "obs", "ims", "nfviecs", "nfvievs", "nfvivpc", "nfvivpn"];
		scenario: "";
