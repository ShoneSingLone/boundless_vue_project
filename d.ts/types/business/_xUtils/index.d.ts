...
type t_xTipsHover = { msg: string; placement?: PopoverPlacement };
export type t_jsxFns = {
	/*
	 * @description v-xtips的h渲染函数简写方法，支持hover
	 *
	 * @param {string} msg
	 * @returns {object}
	 * */
	xTipsHover(t_xTipsHover): object;
	/**
	 * 字符串
	 *
	 ...
	 */
	ActionAndMore(options: t_ActionAndMore): VNode;
	/**
	 * 按钮，confirm在按钮之上的confirm提示
	 */
	TipsDelete(tips: string): VNode;
	/**
	 * 列表， link a 标签 render
	 */
	Link(options: any): VNode;
};
